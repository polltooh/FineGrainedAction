       ...
       if (os.path.isdir(curr_path)):
           ...
           for index in range(len(label_list)):
               if (label_list[index] == "true"):
                   pos_list.append(curr_path + data_list[index].replace(".jpg", ".fc7"))
               else:
                   neg_list.append(curr_path + data_list[index].replace(".jpg", ".fc7"))
...
if __name__ == "__main__":
    ...
    with open("file_list_train_fc7.txt", "w") as f:
        for c in curr_list:
            f.write(c)
